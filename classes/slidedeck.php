...
class SlideDeck {
    ...
    final public function render( $id, $styles = array(), $include_lens_files = true, $preview = false ) {
        ...
        $html.= '<a href="http://www.slidedeck.com/?utm_campaign=LiteUser&utm_medium=chiclet&utm_source=' . urlencode( $_SERVER['HTTP_HOST'] ) . '" rel="external" class="slidedeck-2-bug">SlideDeck 2 Beta</a>';
        $html.= '</div>';
